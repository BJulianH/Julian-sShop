                            ...
                            <div class="card-body">
                                <div class="text-center chat-image mb-5">
                                    ...
                                    <div class="main-chat-msg-name">
                                        <a href="profile.html">
                                            <h5 class="mb-1 text-dark fw-semibold">udin petot</h5>
                                        </a>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="wrap-input100 validate-input input-group">
                                        ...
                                        <input class="input100 form-control" type="text" name="username" value="{{ $user->username }}" placeholder="Username">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="wrap-input100 validate-input input-group">
                                            ...
                                            <input class="input100 form-control" type="text" name="email" value="{{ $user->email }}" placeholder="Email">
                                        </div>
                                <div class="form-group">
                                    ...
                                    <div class="wrap-input100 validate-input input-group" id=>
                                        ...
                                        <input class="input100 form-control" type="password" name="password" placeholder="Current Password">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="wrap-input100 validate-input input-group" id="Password-toggle1">
                                        ...
                                        <input class="input100 form-control" type="password" name="new_password" placeholder="New Password">
                                    </div>
                                    <!-- <input type="password" class="form-control" value="password"> -->
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="wrap-input100 validate-input input-group" id="Password-toggle2">
                                        ...
                                        <input class="input100 form-control" type="password" name="confirm_password" placeholder="Confirm Password">
                                    </div>
                                    <!-- <input type="password" class="form-control" value="password"> -->
                                </div>
                            </div>
...
<div class="col-x1-14">
    <div class="col-x1-14">
        <div class="card">
            ...
            <div class="card-footer text-end">
                <button href="javascript:void(0)" class="btn btn-primary">Update</button>
                <button href="javascript:void(0)" class="btn btn-danger">Cancel</button>
            </div>
        </div>
    </div>
</div>
